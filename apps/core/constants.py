...
# =============================================================================
# POSITION STATUS - Unified lifecycle statuses
# =============================================================================
# Flow: SUGGESTED -> APPROVED -> OPEN -> CLOSED
#                 -> REJECTED (if not approved)

POSITION_STATUS_SUGGESTED = 'SUGGESTED'   # System-generated suggestion awaiting approval
POSITION_STATUS_APPROVED = 'APPROVED'     # User approved, pending execution
POSITION_STATUS_OPEN = 'OPEN'             # Currently open/active position
POSITION_STATUS_CLOSED = 'CLOSED'         # Position closed/exited
POSITION_STATUS_REJECTED = 'REJECTED'     # User rejected the suggestion
POSITION_STATUS_EXPIRED = 'EXPIRED'       # Suggestion expired without action

# Legacy aliases for backward compatibility
POSITION_STATUS_ACTIVE = POSITION_STATUS_OPEN
...
# Position source - where the position/suggestion originated
POSITION_SOURCE_BROKER = 'BROKER'         # Synced from broker
POSITION_SOURCE_SYSTEM = 'SYSTEM'         # Generated by learning/strategy engine
POSITION_SOURCE_MANUAL = 'MANUAL'         # Manually created by user
POSITION_SOURCE_PAPER = 'PAPER'           # Paper (simulated) trade

POSITION_SOURCE_CHOICES = [
    (POSITION_SOURCE_BROKER, 'Broker Sync'),
    (POSITION_SOURCE_SYSTEM, 'System Generated'),
    (POSITION_SOURCE_MANUAL, 'Manual Entry'),
    (POSITION_SOURCE_PAPER, 'Paper Trade'),
]
